/** Curated OSINT bookmarks shown as an optional panel in the in-app browser.
 *  Auto-generated from the course OSINT bookmarks collection. */

export interface BmLink {
  name: string
  url: string
}
...
export const OSINT_BOOKMARKS: BmGroup[] = [
  {
    "name": "Company",
    "groups": [
      {
  ...
  },
  {
    ...
    "links": [
      ...
      {
        "name": "ExoneraTor Tor Relay Search",
  ...
  },
  {
    ...
    "links": [
      ...
      {
        "name": "Fold3 (US Military Records) - Browse records of US Military members",
      ...
      {
        "name": "Canada411 (Canada)",
        "url": "http://www.canada411.ca/"
      },
      {
        "name": "Inmate Location",
      ...
      {
        "name": "The National Archives (United Kingdom)",
        "url": "http://www.nationalarchives.gov.uk/"
      },
      {
        "name": "People Search (Australia)",
  ...
  },
  {
    ...
    "groups": [
      ...
      },
      {
        ...
        "links": [
          ...
          {
            "name": "Archive.org Open Source Videos",
    ...
    "links": [
      ...
      {
        "name": "iSeek",
        "url": "http://education.iseek.com/iseek/home.page"
      },
      {
        "name": "IxQuick",
    ...
    "links": [
      {
        ...
        "url": "http://www.checkusernames.com/"
      },
      {
        "name": "Knowem",
